	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'twoKgDesign' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'twoKgDesign' ); ?></th>
			</tr>
		</thead>
		<tbody>
