	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', '2kgDesign' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', '2kgDesign' ); ?></th>
			</tr>
		</thead>
		<tbody>
