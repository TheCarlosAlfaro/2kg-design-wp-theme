...
<section id="hero-section">
  ...
  <div class="jumbotron jumbotron-fluid">
    ...
    <div class="hero-content">
      ...
      <button type="button" class="btn btn-primary btn-block-xs-only mb-3 mr-2" data-toggle="modal" data-target="#exampleModal">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="iframe-container">
                <iframe width="1280" height="720" src="https://www.youtube.com/embed/CX37OTc3nBo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
          </div>
        </div>
