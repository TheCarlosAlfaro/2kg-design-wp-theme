...
<section id="our-clients-sectino" class="py-5">
  <div class="container h-100">
    <h3 class="text-center mb-5 display-4">OUR CLIENTS</h3>

    <div class="row text-light">
      <div class="col-md-4">
        <div class="card mb-4 box-shadow">
          <img class="card-img-top" src="http://staging.2kgdesign.com/wp-content/uploads/2019/02/client-1.jpg"
            alt="Card image cap">
