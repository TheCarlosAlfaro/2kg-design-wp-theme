...
<section id="blog-section" class="py-5">
  <div class="container">
    <h3 class="text-center mb-5 display-4">THE BLOG</h3>
    <div class="row mb-2">
      ...
      <div class="col-lg">
        <div class="card blog__card--color flex-md-row mb-2 h-md-250">
          <div class="card-body blog__card--text d-flex flex-column align-items-start">
            ...
            <div class="mb-1 text-dark"><?php the_time('M d'); ?></div>
            <p class="card-text mb-auto"><?php echo wp_trim_words(get_the_content(), 4); ?></p>
            <a href="<?php the_permalink() ?>" class="text-dark">Continue reading</a>
          </div>
